package br.com.alexandrealessi.gdx.fox.base.test;
...
public class PathTest extends GdxTest {
    ...
    public void create() {
        ...
        ZIGZAG_SCALE = Gdx.graphics.getDensity() * 300; // 96DP
        ...
        Vector2 cp[] = new Vector2[]{new Vector2(0, 0), new Vector2(w * 0.25f, h * 0.5f), new Vector2(0, h),
                ...
                new Vector2(w * 0.5f, h * 0.25f), new Vector2(w * 0.1f, h * 0.79f), new Vector2(w * 0.9f, h * 0.4f)};
